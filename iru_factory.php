...
$factory->define(Iru_model::class, function (Faker\Generator $faker) {
    ...
    return [
        ...
        'name' => $computerName,
        'iru_agent_version' => $faker->randomElement(['5.1.0.700', '5.0.0.650', '3.3.0.607']),
